class Planet
{
  ...
  void randomize()
    {
    this.size = this.generation*10; //random(10,40);
    this.dist =this.generation*100;                   //random(50,400);
    this.angle = this.generation*1;                          //random(360);
    this.speed = random(-.2,.2)*this.generation; //random(-2,2);
    colorMode(HSB, 260,100,100);
    this.col = color(this.generation,100,100);
    }
