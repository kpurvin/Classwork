class Mover
{
 ...
 // if(this.dist<30) this.live = false; 
  ...
  if(living<75) max_speed = random(.75,7); max_acceleration = random(.15,1.5);
  if(living<37) max_speed = random(1,10); max_acceleration = random(.2,2);
  if(living<19) max_speed = random(1.5,15); max_acceleration = random(.25,2.5);
  if(living<9) max_speed = random(2,20); max_acceleration = random(.3,3);
  if(living<5) max_speed = random(2.5,25); max_acceleration = random(.35,3.5);
  if(living<3) max_speed = random(3,30); max_acceleration = random(.4,4);
  if(living<2) max_speed = random(3.5,35); max_acceleration = random(.45,4.5);
